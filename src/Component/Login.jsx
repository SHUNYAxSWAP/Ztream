      ...
      {loggedIn ?
        (<div className="h-screen w-screen my-auto text-white flex justify-center items-center flex-col">
          <div>
            ...
            <form action="" method="post" className="flex gap-3 flex-col ">
              <input type="email" name="" id="" className="border border-solid px-12 py-3 bg-[#020202] rounded-md" placeholder="Email or mobile number" />
              <button type="button" className="font-bold px-12 py-3 bg-[#ff0f1f] text-white rounded-md hover:bg-red-700 transition">Continue</button>
            </form>
          </div>
        ...
        : <div className="h-full text-white flex justify-center items-center flex-col">
          ...
          <form action="" method="post" className="flex gap-3">
            <input type="email" name="" id="" className="border border-solid px-12 py-3 bg-[#020202] rounded-md" placeholder="Email" />
            <button type="button" className="font-bold px-12 py-3 bg-[#ff0f1f] text-white rounded-md hover:bg-red-700 transition">Get Started </button>
          </form>
        </div>}
