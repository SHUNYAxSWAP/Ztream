...
const Home = () => {
  ...
  return (
    <div className="h-screen w-screen">
      <Background />
      {loggedIn ? (<div className="h-screen w-screen my-auto text-white flex justify-center items-center flex-col">
        <div>
          ...
          <form action="" method="post" className="flex gap-3 flex-col ">
            ...
            <button type="button" className="font-bold px-12 py-3 bg-[#ff0f1f] text-white rounded-md hover:bg-red-700 transition" onClick={handleBtnClick}>Continue</button>
          </form>
        ...
        : (<div className="h-full text-white flex justify-center items-center flex-col">
          ...
          <form action="" method="post" className="flex gap-3">
            ...
            <button type="button" className="font-bold px-12 py-3 bg-[#ff0f1f] text-white rounded-md hover:bg-red-700 transition" onClick={handleBtnClick}>Get Started </button>
          </form>
          <p className="text-red-500 font-bold m-5">{errMsg}</p>
        </div>)}
    </div >
